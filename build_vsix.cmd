...
rem Workaround to make the VSIX build succeed
if not exist ".\_build\Microsoft.Windows.CppWinRT.3.0.260818.1.nupkg" powershell -Command "Invoke-WebRequest https://www.nuget.org/api/v2/package/Microsoft.Windows.CppWinRT/3.0.260818.1 -OutFile ".\_build\Microsoft.Windows.CppWinRT.%target_version%.nupkg"
