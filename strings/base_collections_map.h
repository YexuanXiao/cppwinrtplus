...
{
    WINRT_EXPORT template <typename K, typename V, typename Compare = std::less<K>, typename Allocator = std::allocator<std::pair<K const, V>>>
    ...
    WINRT_EXPORT template <typename K, typename V, typename Hash = std::hash<K>, typename KeyEqual = std::equal_to<K>, typename Allocator = std::allocator<std::pair<K const, V>>>
...
extern "C++" namespace winrt::Windows::Foundation::Collections
{
    template<std::size_t Idx, typename K, typename V>
