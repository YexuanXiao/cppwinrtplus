...
namespace winrt
{
    ...
    template <typename Dispatcher, typename Traits = dispatcher_traits<Dispatcher>, typename = std::void_t<decltype(sizeof(Traits))>>
    [[nodiscard]] auto resume_foreground(Dispatcher const& dispatcher, typename Traits::Priority priority = Traits::Priority::Normal)
    {
        ...
        public:
            ...
            awaitable(Dispatcher const& d, Priority p) noexcept :
                m_dispatcher(d), m_priority(p) {}
