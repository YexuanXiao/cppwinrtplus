...
namespace
{
    ...
    void test_guids()
    {
        ...
        REQUIRE_EQUAL_GUID("95500129-FBF6-5AFC-89DF-70642D741990", IReference<std::int8_t>);
        REQUIRE_EQUAL_GUID("6EC9E41B-6709-5647-9918-A1270110FC4E", IReference<std::int16_t>);
        REQUIRE_EQUAL_GUID("548CEFBD-BC8A-5FA0-8DF2-957440FC8BF4", IReference<std::int32_t>);
        REQUIRE_EQUAL_GUID("4DDA9E24-E69F-5C6A-A0A6-93427365AF2A", IReference<std::int64_t>);
        REQUIRE_EQUAL_GUID("e5198cc8-2873-55f5-b0a1-84ff9e4aad62", IReference<std::uint8_t>);
        REQUIRE_EQUAL_GUID("5AB7D2C3-6B62-5E71-A4B6-2D49C4F238FD", IReference<std::uint16_t>);
        REQUIRE_EQUAL_GUID("513ef3af-e784-5325-a91e-97c2b8111cf3", IReference<std::uint32_t>);
        REQUIRE_EQUAL_GUID("6755e376-53bb-568b-a11d-17239868309e", IReference<std::uint64_t>);
