...
static_assert(string_view_equal(impl::xaml_typename_name<std::uint8_t>::value(), L"UInt8"sv));
static_assert(string_view_equal(impl::xaml_typename_name<std::int8_t>::value(), L"Int8"sv));
static_assert(string_view_equal(impl::xaml_typename_name<std::uint16_t>::value(), L"UInt16"sv));
static_assert(string_view_equal(impl::xaml_typename_name<std::int16_t>::value(), L"Int16"sv));
static_assert(string_view_equal(impl::xaml_typename_name<std::uint32_t>::value(), L"UInt32"sv));
static_assert(string_view_equal(impl::xaml_typename_name<std::int32_t>::value(), L"Int32"sv));
static_assert(string_view_equal(impl::xaml_typename_name<std::uint64_t>::value(), L"UInt64"sv));
static_assert(string_view_equal(impl::xaml_typename_name<std::int64_t>::value(), L"Int64"sv));
...
static_assert(impl::xaml_typename_kind<std::uint8_t>::value == Windows::UI::Xaml::Interop::TypeKind::Primitive);
static_assert(impl::xaml_typename_kind<std::int8_t>::value == Windows::UI::Xaml::Interop::TypeKind::Primitive);
static_assert(impl::xaml_typename_kind<std::uint16_t>::value == Windows::UI::Xaml::Interop::TypeKind::Primitive);
static_assert(impl::xaml_typename_kind<std::int16_t>::value == Windows::UI::Xaml::Interop::TypeKind::Primitive);
static_assert(impl::xaml_typename_kind<std::uint32_t>::value == Windows::UI::Xaml::Interop::TypeKind::Primitive);
static_assert(impl::xaml_typename_kind<std::int32_t>::value == Windows::UI::Xaml::Interop::TypeKind::Primitive);
static_assert(impl::xaml_typename_kind<std::uint64_t>::value == Windows::UI::Xaml::Interop::TypeKind::Primitive);
static_assert(impl::xaml_typename_kind<std::int64_t>::value == Windows::UI::Xaml::Interop::TypeKind::Primitive);
...
TEST_CASE("xaml_typename")
{
    ...
    REQUIRE(equals(TypeName{ hstring(L"UInt8"sv), TypeKind::Primitive }, xaml_typename<std::uint8_t>()));
    REQUIRE(equals(TypeName{ hstring(L"Int8"sv), TypeKind::Primitive }, xaml_typename<std::int8_t>()));
    REQUIRE(equals(TypeName{ hstring(L"UInt16"sv), TypeKind::Primitive }, xaml_typename<std::uint16_t>()));
    REQUIRE(equals(TypeName{ hstring(L"Int16"sv), TypeKind::Primitive }, xaml_typename<std::int16_t>()));
    REQUIRE(equals(TypeName{ hstring(L"UInt32"sv), TypeKind::Primitive }, xaml_typename<std::uint32_t>()));
    REQUIRE(equals(TypeName{ hstring(L"Int32"sv), TypeKind::Primitive }, xaml_typename<std::int32_t>()));
    REQUIRE(equals(TypeName{ hstring(L"UInt64"sv), TypeKind::Primitive }, xaml_typename<std::uint64_t>()));
    REQUIRE(equals(TypeName{ hstring(L"Int64"sv), TypeKind::Primitive }, xaml_typename<std::int64_t>()));
